...
def minimax(grille, profondeur, alpha, beta, estMaximisant):
    ...
    if estMaximisant:
        ...
        for i in range(3):
            for j in range(3):
                if grille[i][j] == '-':
                    grille[i][j] = 'X'
                    score = minimax(grille, profondeur + 1, alpha, beta, False)
                    grille[i][j] = '-'
        ...
        for i in range(3):
            for j in range(3):
                if grille[i][j] == '-':
                    grille[i][j] = 'O'
                    score = minimax(grille, profondeur + 1, alpha, beta, True)
                    grille[i][j] = '-'
...
def meilleurCoup(grille):
    ...
    for i in range(3):
        for j in range(3):
            if grille[i][j] == '-':
                grille[i][j] = 'X'
                score = minimax(grille, 0, alpha, beta, False)
                grille[i][j] = '-'
